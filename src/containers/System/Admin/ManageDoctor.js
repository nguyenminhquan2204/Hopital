...
class ManageDoctor extends Component {
   ...
   componentDidUpdate(prevProps, prevState, snapshot) {
      if(prevProps.allDoctors !== this.props.allDoctors) {
         let data = this.buildDataInputSelect(this.props.allDoctors, 'USERS');
         this.setState({
            listDoctors: data
         })
      }
   ...
   handleChangeSelect = async (selectedDoctor) => {
      ...
      if(res && res.errorCode === 0 && res.data && res.data.Markdown) {
         ...
         let selectedClinic = '' , selectedPayment = '', selectedPrice = '', selectedProvince = '', selectedSpecialty = '';
         ...
         if(res.data.Doctor_Infor) {
            ...
            // console.log('hhhhhhhhhhh', res.data.Doctor_Infor);
   ...
   handleChangeSelectDoctorInfor = async (selectedOption, name) => {
      // console.log('aaaaa',selectedOption, name);
      let stateName = name.name;
      // console.log('bbbb', stateName);
   ...
   render() {
      ...
      console.log("Check specialty", this.state.listSpecialty);
            ...
            <div className="manage-doctor-container">
               ...
               <div className='more-infor-extra row'>
                  ...
                  <div className='col-4 form-group'>
                     ...
                     <input 
                        className='form-control'
                        onChange={(e) => this.hanldeOnChangeText(e, 'nameClinic')}
                  ...
                  <div className='col-4 form-group'>
                     ...
                     <input 
                        className='form-control'
                        onChange={(e) => this.hanldeOnChangeText(e, 'addressClinic')}
                  ...
                  <div className='col-4 form-group'>
                     ...
                     <input 
                        className='form-control'
                        onChange={(e) => this.hanldeOnChangeText(e, 'note')}
